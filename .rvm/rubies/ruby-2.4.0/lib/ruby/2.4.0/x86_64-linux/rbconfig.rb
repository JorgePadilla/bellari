...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/ec2-user/.rvm/rubies/ruby-2.4.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/ec2-user/.rvm/rubies/ruby-2.4.0' '--disable-install-doc' '--enable-shared'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/home/ec2-user/.rvm/rubies/ruby-2.4.0"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (GCC) 4.8.3 20140911 (Red Hat 4.8.3-9)\nCopyright (C) 2013 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
