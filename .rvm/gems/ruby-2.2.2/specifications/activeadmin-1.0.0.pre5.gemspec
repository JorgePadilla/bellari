# -*- encoding: utf-8 -*-
# stub: activeadmin 1.0.0.pre5 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<arbre>.freeze, [">= 1.0.2", "~> 1.0"])
      ...
      s.add_runtime_dependency(%q<inherited_resources>.freeze, ["~> 1.6"])
      ...
      s.add_dependency(%q<arbre>.freeze, [">= 1.0.2", "~> 1.0"])
      ...
      s.add_dependency(%q<inherited_resources>.freeze, ["~> 1.6"])
